...
export function PowersPanel({
  ...
  // Pre-path players have mana AND stamina pathResource - we show mana (MP) for them
  // Active path players (with fury, momentum, etc.) show their path resource instead
