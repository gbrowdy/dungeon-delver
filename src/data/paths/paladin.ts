...
export const PALADIN_PATHS: PathDefinition[] = [
  {
    ...
    subpaths: [
      {
        ...
        icon: 'ability-paths-paladin-templar',
      ...
      },
      {
        ...
        icon: 'ability-paths-paladin-inquisitor',
    ...
    abilities: [
      // TEMPLAR SUBPATH - Holy Burst Damage
      {
        ...
        icon: 'ability-paths-paladin-holy_strike',
        levelRequired: 3,
        subpath: 'templar',
        effects: [
          {
      ...
      },
      {
        ...
        icon: 'ability-paths-paladin-righteous_fury',
        levelRequired: 4,
        subpath: 'templar',
        effects: [
          {
      ...
      },
      {
        ...
        icon: 'ability-paths-paladin-smite_the_wicked',
        levelRequired: 5,
        subpath: 'templar',
        effects: [
          {
      ...
      // INQUISITOR SUBPATH - Enemy Debuffs
      {
        ...
        icon: 'ability-paths-paladin-mark_of_judgment',
        levelRequired: 3,
        subpath: 'inquisitor',
        effects: [
          {
      ...
      },
      {
        ...
        icon: 'ability-paths-paladin-weakening_light',
        levelRequired: 4,
        subpath: 'inquisitor',
        effects: [
          {
      ...
      },
      {
        ...
        icon: 'ability-paths-paladin-divine_condemnation',
        levelRequired: 5,
        subpath: 'inquisitor',
        effects: [
          {
      ...
      // SHARED/CAPSTONE
      {
        ...
        icon: 'ability-paths-paladin-crusader_holy_avenger',
        levelRequired: 6,
        subpath: 'templar',
        isCapstone: true,
        effects: [
  ...
  },
  {
    ...
    subpaths: [
      {
        ...
        icon: 'ability-paths-paladin-sentinel',
      ...
      },
      {
        ...
        icon: 'ability-paths-paladin-martyr',
    ...
    abilities: [
      // SENTINEL SUBPATH - Regen Scaling
      {
        ...
        icon: 'ability-paths-paladin-blessed_recovery',
        levelRequired: 3,
        subpath: 'sentinel',
        effects: [
          {
      ...
      },
      {
        ...
        icon: 'ability-paths-paladin-healing_ward',
        levelRequired: 4,
        subpath: 'sentinel',
        effects: [
          {
      ...
      // MARTYR SUBPATH - Damage Reduction
      {
        ...
        icon: 'ability-paths-paladin-enduring_faith',
        levelRequired: 3,
        subpath: 'martyr',
        effects: [
          {
      ...
      },
      {
        ...
        icon: 'ability-paths-paladin-armor_of_sacrifice',
        levelRequired: 4,
        subpath: 'martyr',
        effects: [
          {
      ...
      },
      {
        ...
        icon: 'ability-paths-paladin-last_stand',
        levelRequired: 5,
        subpath: 'martyr',
        effects: [
          {
      ...
      // CAPSTONES
      {
        ...
        icon: 'ability-paths-paladin-protector_eternal_guardian',
        levelRequired: 6,
        subpath: 'sentinel',
        isCapstone: true,
        effects: [
      ...
      },
      {
        ...
        icon: 'ability-paths-paladin-protector_unbreakable_will',
        levelRequired: 6,
        subpath: 'martyr',
        isCapstone: true,
        effects: [
