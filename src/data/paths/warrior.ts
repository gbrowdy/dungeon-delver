...
const BERSERKER_ABILITIES: PathAbility[] = [
  ...
  },
  {
    ...
    icon: 'ability-paths-warrior-pain_fueled',
    levelRequired: 3,
    isCapstone: false,
    subpath: null,
    effects: [
  ...
  },
  {
    ...
    icon: 'ability-paths-warrior-bloodbath',
    levelRequired: 4,
    isCapstone: false,
    subpath: null,
    effects: [
  ...
  },
  {
    ...
    icon: 'ability-paths-warrior-battle_trance',
    levelRequired: 5,
    isCapstone: false,
    subpath: null,
    effects: [
  ...
  // Warlord Subpath - Control and battlefield dominance
  {
    ...
    icon: 'ability-paths-warrior-intimidating_presence',
    levelRequired: 3,
    isCapstone: false,
    subpath: 'warlord',
    effects: [
  ...
  },
  {
    ...
    icon: 'ability-paths-warrior-warlord_command',
    levelRequired: 4,
    isCapstone: false,
    subpath: 'warlord',
    effects: [
  ...
  },
  {
    ...
    icon: 'ability-paths-warrior-crushing_blows',
    levelRequired: 5,
    isCapstone: false,
    subpath: 'warlord',
    effects: [
  ...
  // Executioner Subpath - Burst damage and execution
  {
    ...
    icon: 'ability-paths-warrior-executioners_strike',
    levelRequired: 3,
    isCapstone: false,
    subpath: 'executioner',
    effects: [
  ...
  },
  {
    ...
    icon: 'ability-paths-warrior-killing_spree',
    levelRequired: 4,
    isCapstone: false,
    subpath: 'executioner',
    effects: [
  ...
  },
  {
    ...
    icon: 'ability-paths-warrior-mortal_wounds',
    levelRequired: 5,
    isCapstone: false,
    subpath: 'executioner',
    effects: [
  ...
  // Berserker Capstone
  {
    ...
    icon: 'ability-paths-warrior-undying_fury',
    levelRequired: 6,
    isCapstone: true,
    subpath: null,
    effects: [
...
const WARLORD_SUBPATH: SubpathDefinition = {
  ...
  icon: 'ability-paths-warrior-warlord',
  theme: 'control'
};
...
const EXECUTIONER_SUBPATH: SubpathDefinition = {
  ...
  icon: 'ability-paths-warrior-executioner',
  theme: 'burst_damage'
};
...
const GUARDIAN_ABILITIES: PathAbility[] = [
  ...
  },
  {
    ...
    icon: 'ability-paths-warrior-regeneration',
    levelRequired: 3,
    isCapstone: false,
    subpath: null,
    effects: [
  ...
  },
  {
    ...
    icon: 'ability-paths-warrior-damage_reduction',
    levelRequired: 4,
    isCapstone: false,
    subpath: null,
    effects: [
  ...
  },
  {
    ...
    icon: 'ability-paths-warrior-last_stand',
    levelRequired: 5,
    isCapstone: false,
    subpath: null,
    effects: [
  ...
  },
  {
    ...
    icon: 'ability-paths-warrior-endurance',
    levelRequired: 5,
    isCapstone: false,
    subpath: null,
    effects: [
  ...
  // Fortress Subpath - Pure tank focus
  {
    ...
    icon: 'ability-paths-warrior-fortress_stance',
    levelRequired: 3,
    isCapstone: false,
    subpath: 'fortress',
    effects: [
  ...
  },
  {
    ...
    icon: 'ability-paths-warrior-immovable_object',
    levelRequired: 4,
    isCapstone: false,
    subpath: 'fortress',
    effects: [
  ...
  },
  {
    ...
    icon: 'ability-paths-warrior-healing_aura',
    levelRequired: 5,
    isCapstone: false,
    subpath: 'fortress',
    effects: [
  ...
  // Avenger Subpath - Counter-attack and retaliation
  {
    ...
    icon: 'ability-paths-warrior-thorns',
    levelRequired: 3,
    isCapstone: false,
    subpath: 'avenger',
    effects: [
  ...
  },
  {
    ...
    icon: 'ability-paths-warrior-vengeful_strike',
    levelRequired: 4,
    isCapstone: false,
    subpath: 'avenger',
    effects: [
  ...
  // Guardian Capstone
  {
    ...
    icon: 'ability-paths-warrior-immortal_guardian',
    levelRequired: 6,
    isCapstone: true,
    subpath: null,
    effects: [
...
const FORTRESS_SUBPATH: SubpathDefinition = {
  ...
  icon: 'ability-paths-warrior-fortress',
  theme: 'tank'
};
...
const AVENGER_SUBPATH: SubpathDefinition = {
  ...
  icon: 'ability-paths-warrior-avenger',
  theme: 'retaliation'
};
