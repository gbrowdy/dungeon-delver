 ...
 * All items cost 150 gold and synergize with class/path identity
 *
 * Structure:
    ...
    paths: {
      ...
      guardian: [
        ...
        },
        {
          ...
          tier: 'class',
          icon: 'Heart',
          description: '+15 Health, +2 Armor. Block costs 5 less mana.',
          classRestriction: 'warrior',
          pathRestriction: 'guardian',
          effectDescription: 'Block: -5 mana cost',
        },
      ],
    },
  },
    ...
    base: [
      {
        ...
        type: 'weapon',
        price: 150,
        stats: { power: 5, mana: 10 },
        tier: 'class',
        icon: 'Wand2',
        description: '+5 Power, +10 Mana. Arcane-infused staff.',
      ...
      },
      {
        ...
        type: 'armor',
        price: 150,
        stats: { armor: 1, maxMana: 20 },
        tier: 'class',
        icon: 'Shirt',
        description: '+1 Armor, +20 Max Mana. Enchanted robes.',
        classRestriction: 'mage',
      },
      {
        id: 'mage_focus',
        ...
        type: 'accessory',
        price: 150,
        stats: { power: 2, maxMana: 15 },
        tier: 'class',
        icon: 'Sparkles',
        description: '+2 Power, +15 Max Mana. Powers cost 5% less mana.',
        classRestriction: 'mage',
        effectDescription: '-5% power mana cost',
      },
    ],
    paths: {
      ...
      archmage: [
        ...
        },
        {
          ...
          type: 'accessory',
          price: 150,
          stats: { power: 4, maxMana: 10 },
          tier: 'class',
          icon: 'Zap',
          description: '+4 Power, +10 Max Mana. Fireball cooldown reduced by 15%.',
          classRestriction: 'mage',
          pathRestriction: 'archmage',
      ...
      enchanter: [
        {
          ...
          type: 'weapon',
          price: 150,
          stats: { power: 4, maxMana: 15 },
          tier: 'class',
          icon: 'Wand2',
          description: '+4 Power, +15 Max Mana. Restore 2 mana per second.',
          classRestriction: 'mage',
          pathRestriction: 'enchanter',
          effectDescription: '+2 mana regen/sec',
        },
        {
          ...
          type: 'armor',
          price: 150,
          stats: { armor: 2, maxMana: 25 },
          tier: 'class',
          icon: 'Sparkles',
          description: '+2 Armor, +25 Max Mana. Aura effects 10% stronger.',
          classRestriction: 'mage',
          pathRestriction: 'enchanter',
        ...
        },
        {
          ...
          type: 'accessory',
          price: 150,
          stats: { power: 3, maxMana: 15 },
          tier: 'class',
          icon: 'Sparkles',
          description: '+3 Power, +15 Max Mana. Auto-effects trigger 10% more often.',
          classRestriction: 'mage',
          pathRestriction: 'enchanter',
  ...
  rogue: {
    base: [
      ...
      },
      {
        ...
        tier: 'class',
        icon: 'CircleDot',
        description: '+10 Fortune, +2 Speed. Critical hits restore 3 mana.',
        classRestriction: 'rogue',
        effectDescription: 'On crit: +3 mana',
      },
    ],
    paths: {
      ...
      duelist: [
        ...
        },
        {
          ...
          tier: 'class',
          icon: 'Sparkles',
          description: '+12 Fortune, +3 Speed. Dodging restores 5 mana.',
          classRestriction: 'rogue',
          pathRestriction: 'duelist',
          effectDescription: 'On dodge: +5 mana',
        },
      ],
    },
  },
  ...
  paladin: {
    base: [
      ...
      },
      {
        ...
        type: 'accessory',
        price: 150,
        stats: { maxMana: 15, maxHealth: 10 },
        tier: 'class',
        icon: 'Cross',
        description: '+15 Max Mana, +10 Health. Divine Heal heals 5% more.',
        classRestriction: 'paladin',
